    ...
    <div className='group relative bg-white rounded-xl hover:shadow-xl transition-all duration-300 ease-in-out overflow-hidden flex flex-col h-full w-full'>
      ...
      <div className='p-4 flex flex-col grow'>
        ...
        <button
          ...
          className='mt-4 w-full py-2 bg-gray-900 text-white font-medium rounded-lg hover:bg-rose-600 transition-colors duration-200 shadow-md hover:shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed'
        >
          {!product.in_stock || product.stock <= 0
            ? 'OUT OF STOCK'
            : 'ADD TO CART'}
